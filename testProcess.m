...
recordingOn = 	2;  % invoke for recording from microphone (0 for random segment)
duration = 10;      % [sec]
                                               % loads database 
...
if (recordingOn == 0)                                            % select a random segment
...
external_FILENAME = fullfile('Short clips', 'Aathadi-[AudioTrimmer.com].mp3');             % external custom audio clip file name
